...
void loop() {  
  if (heating = true) {
    ...
    // If using an active low SSR, set the heater pin to LOW for ON, and HIGH for off.
    ...
    else if (currentTemp > (setTemperature)) 
    {
      ...
      digitalWrite(FAN_PIN, HIGH); // Keep Fan On to curculate the warm air
